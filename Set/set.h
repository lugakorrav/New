...
// Всего в методах множества используется 4 алгоритма сложностью О(N). Посредством удвоения размера множества вместо 
// выделения памяти при каждом добавлении элемента получена более высокая производительность за счет увеличения требуемой памяти.
